...
/* 20120222 bkw: renamed strlcat() to str_lower_cat() because it
	breaks compilation on FreeBSD and related OSes, which already
	have a strlcat(char *, const char *, size). Note the different signature.  */
