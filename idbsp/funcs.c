...
void 	*ReadWAD(FILE *f, unsigned int num, size_t size)
{
	int	numread;
	void	*p;
...
void *ReadStorage(FILE *f, lumpinfo_t *dir, unsigned int *num, size_t size)
{
...
void WriteLines(FILE *f, unsigned int num, maplinedef_t *lines, mapvertex_t *vertexes,
...
void WriteThings(FILE *f, unsigned int num, mapthing_t *t)
{
	int	i;
